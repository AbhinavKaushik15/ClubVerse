    ...
    <div className='w-full'>
      {visible && (
        <button
          ...
          className="flex fixed cursor-pointer z-[12] right-10 bottom-10 after:content-['scroll_to_top'] after:text-white after:absolute after:text-nowrap after:scale-0 hover:after:scale-100 transition-all ease-linear after:duration-200 w-16 h-16 rounded-full border-4 border-[#3A72EC] bg-black pointer items-center justify-center duration-300 hover:rounded-[50px] hover:w-36 group/button overflow-hidden active:scale-90"
        >
          <svg
